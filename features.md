...
* *I'm using STT (Speech to text) to be able to easily brain dump all the feature ideas that I'd like to have. I will go back and make sure to re-edit this markdown file. So it's in much cleaner markdown format. And specific tasks that as features that I'd like to complete.* *
